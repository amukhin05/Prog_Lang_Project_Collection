...
`assigns`: contains all code files for this project
...
- interp1 - interp3: contain implementations of self-defined programming languages of increasing complexity. Each interp folder has a structure similar to the following:
  ...
  - interp1.ml, interp2.ml, interp3.ml: contain the main code for the respective projects (OCaml file)
  - utils.ml: contains type definitions and basic helper functions (OCaml file)
